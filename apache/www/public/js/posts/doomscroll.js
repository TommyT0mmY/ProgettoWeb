...
class DoomScroll {
    ...
    createPostElement(post) {
        ...
        if (post.category) {
            const categoryElement = article.querySelector('[data-field="category"]');
            categoryElement.style.display = '';
            categoryElement.querySelector('[data-field="categoryName"]').textContent = post.category.categoryName;
        }
        ...
        if (post.attachmentPath) {
            const attachmentLi = article.querySelector('[data-field="attachment"]');
            attachmentLi.style.display = '';
            attachmentLi.querySelector('[data-field="attachmentPath"]').href = post.attachmentPath;
        }
...
document.addEventListener('DOMContentLoaded', () => {
    if (window.#postManager) {
        new DoomScroll(window.#postManager);
    } else {
        console.warn('PostManager not available for DoomScroll.');
    }
});
