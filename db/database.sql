...
-- password: 'aaaaaa'
('testuser', 'Test', 'User', 1, '$2y$12$IopdjTqt.gNIuYN7FDXZJOZo.02BGca/Jw0uf0v0xhsN89gf9HoCW');
...
(4, 'Esercizi d\'esame - Algebra', 'Ho trovato degli esercizi degli anni passati, chi me li spiega?', '2024-01-27 15:45:00', 'testuser', 1, 1),
...
(7, 'Domanda su Integrali', 'Qual è il metodo migliore per calcolare integrali impropri? Mi confondo tra i vari casi.', '2024-01-25 14:25:00', 'testuser', 2, 1),
...
(12, 'Condivisione progetto di esempio', 'Ho creato un programma di gestione liste che potrebbe essere utile per esercitarsi.', '2024-01-29 16:50:00', 'testuser', 3, 2),
...
(26, 'Serie Numeriche - Aiuto!', 'Non riesco proprio a capire il criterio del rapporto per le serie. Quando una serie converge?', '2024-02-10 09:45:00', 'testuser', 2, 1),
...
(33, 'Esame di programmazione - cosa aspettarsi?', 'Per chi ha già dato l\'esame: com\'è strutturato? Più teoria o pratica al computer?', '2024-02-17 14:00:00', 'testuser', 3, 1),
...
(36, 'Hash table e collisioni', 'Come si gestiscono le collisioni nelle hash table? Concatenamento o indirizzamento aperto?', '2024-02-20 16:45:00', 'testuser', 4, 1),
...
(41, 'Moto circolare uniforme', 'La forza centripeta punta sempre verso il centro, giusto? E l\'accelerazione centripeta è v²/r?', '2024-02-25 09:15:00', 'testuser', 5, 1),
...
(5, 2, 'Manca la parte sulle basi? O solo io non la trovo?', '2024-01-24 13:30:00', 'testuser', NULL),
...
(11, 4, 'Ok! Allora io ho il determinante ma non so come ricavare il rango da quello.', '2024-01-27 17:00:00', 'testuser', 10),
...
(13, 5, 'Grazie Luca! Mi hanno aiutato un sacco, specie gli esempi sui limiti notevoli.', '2024-01-16 13:00:00', 'testuser', NULL),
...
(21, 7, 'Ok, quindi bisogna sempre passare attraverso il limite per gli impropri? Non c\'è un metodo diretto?', '2024-01-25 16:15:00', 'testuser', 20),
...
(25, 9, 'Una funzione è continua se non ha "salti", derivabile se è "liscia" (no punti angolosi).', '2024-01-02 12:00:00', 'testuser', NULL),
...
(32, 11, 'Esatto! E *p ti serve per accedere al valore memorizzato a quell\'indirizzo.', '2024-01-28 12:15:00', 'testuser', 31),
...
(34, 12, 'Certo! Sentiti libero, il codice è commentato così impari come funziona.', '2024-01-30 09:30:00', 'testuser', 33),
...
(37, 13, 'Scusami, qual è la complessità del merge sort?', '2024-01-21 10:00:00', 'testuser', NULL),
...
(41, 14, 'Ok grazie ragazzi! Ho trovato anche un video su youtube molto chiaro, se vi serve lo mando.', '2024-01-30 15:15:00', 'testuser', 40),

-- Post 15: Esercizi ASD
(42, 15, 'Sì, anch\'io! Particolarmente il terzo esercizio su grafi, che ne pensate della soluzione?', '2024-02-02 15:30:00', 'testuser', NULL),
...
(50, 18, 'Posso unirmi anche io? Ho tempo sabato pomeriggio.', '2024-02-04 11:00:00', 'testuser', NULL),
...
(68, 25, 'Grazie Luca! L\'esercizio 4.12 sul nucleo e immagine mi stava facendo impazzire.', '2024-02-09 17:00:00', 'testuser', NULL),
...
(72, 26, 'Quando viene =1 cosa faccio?', '2024-02-10 11:00:00', 'testuser', 71),
(73, 26, 'Devi provare altri criteri: radice, confronto, condensazione...', '2024-02-10 11:30:00', 'l.bianchi', 72),
(74, 26, 'Ok grazie! Provo con il criterio della radice allora.', '2024-02-10 12:00:00', 'testuser', 73),
...
(78, 28, 'Sei una salvatrice Giulia! Proprio quello che mi serviva per prepararmi.', '2024-02-12 16:00:00', 'testuser', NULL),
...
(83, 29, 'Posso venire anche io? Ho bisogno di fare pratica sugli asintoti.', '2024-02-13 11:30:00', 'testuser', NULL),
...
(87, 30, 'Free quando hai finito di usare quella memoria. Se allochi in main, free in main prima di return.', '2024-02-14 15:15:00', 'testuser', 86),
...
(92, 32, 'Usa "print nome_variabile" o "p nome_variabile" in breve.', '2024-02-16 12:00:00', 'testuser', 91),
...
(94, 33, 'Quanto tempo danno per la parte pratica?', '2024-02-17 15:00:00', 'testuser', 93),
...
(98, 34, 'Esatto, se bilanciato! Se sbilanciato degenera a O(n).', '2024-02-18 13:00:00', 'testuser', 97),
...
(100, 35, 'Hai incluso anche lo spazio oltre al tempo?', '2024-02-19 10:30:00', 'testuser', NULL),
...
(103, 36, 'Quale è meglio?', '2024-02-20 17:45:00', 'testuser', 102),
...
(106, 37, 'Esempio: Fibonacci è DP, cambio monete può essere greedy.', '2024-02-21 14:30:00', 'testuser', 105),
...
(112, 39, 'Esatto! L_attrito = -f_attrito × d, è sempre negativo.', '2024-02-23 16:00:00', 'testuser', 111),
...
(114, 40, 'La parte su quantità di moto è spiegata meglio del libro!', '2024-02-24 12:30:00', 'testuser', NULL),
...
(116, 41, 'E la velocità tangenziale è perpendicolare alla centripeta?', '2024-02-25 10:30:00', 'testuser', 115),
...
(128, 45, 'Posso unirmi? Mi servono esercizi sulle moli.', '2024-03-01 12:30:00', 'testuser', NULL),
